...
public class DBemployee extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String query = "CREATE TABLE employees ( ID INTEGER PRIMARY KEY, admin TEXT, employee TEXT, customer TEXT, animal TEXT, firstName TEXT, lastName TEXT, phoneNumber TEXT, email TEXT, home TEXT)";
		db.execSQL(query);
	}
	...
	public void insertEmployee(HashMap<String, String> queryValues) {
		...
		values.put("animal", queryValues.get("animal"));
	...
	public ArrayList<HashMap<String, String>> getAllEmployees() {
		...
		SQLiteDatabase database = this.getWritableDatabase();
		String selectQuery = "SELECT  * FROM employees ORDER BY lastName";
		// ----Extract Data----
		...
		if (cursor.moveToFirst()) {
			do {
				...
				map.put("animal", cursor.getString(4));
				map.put("firstName", cursor.getString(5));
				map.put("lastName", cursor.getString(6));
				map.put("phoneNumber", cursor.getString(7));
				map.put("email", cursor.getString(8));
				map.put("home", cursor.getString(9));
	...
	public HashMap<String, String> getEmployeeInfo(String id) {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				employee.put("animal", cursor.getString(4));
				employee.put("firstName", cursor.getString(5));
				employee.put("lastName", cursor.getString(6));
				employee.put("phoneNumber", cursor.getString(7));
				employee.put("email", cursor.getString(8));
				employee.put("home", cursor.getString(9));
